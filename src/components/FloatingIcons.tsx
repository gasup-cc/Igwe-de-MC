...
const icons: IconConfig[] = [
  ...
  { Icon: Star, left: "75%", top: "35%", color: "#F0CC5A", size: 18, floatY: -25, rotateDeg: 8, duration: 5.5, delay: 0.9, hideOnMobile: true },
...
export const FloatingIcons = () => {
  ...
  const opacityRange = isMobile ? [0.08, 0.22] : [0.12, 0.35];

  ...
  return (
    <section className="py-24 md:py-28 bg-surface-2">
      <div className="container-x">
        ...
        <div ref={scrollRef} className="flex gap-5 overflow-x-auto snap-x snap-mandatory scrollbar-hide -mx-5 px-5 pb-4">
          {testimonials.map((t, i) => (
            <GlassCard key={i} padding="p-8" className="min-w-[320px] sm:min-w-[380px] snap-start flex flex-col gap-5">

        ...
        <div className="container-x grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="space-y-7">
            ...
            <div className="pt-4 flex flex-wrap gap-3">
              <a href="tel:+447733751948" className="glass rounded-md px-4 py-3 text-sm flex items-center gap-2 hover:border-gold/40 transition"><Phone className="w-4 h-4 text-gold" /> +44 7733 751948</a>
              <a href="https://wa.me/447733751948" target="_blank" rel="noreferrer" className="glass rounded-md px-4 py-3 text-sm flex items-center gap-2 hover:border-gold/40 transition"><MessageCircle className="w-4 h-4 text-[#25D366]" /> WhatsApp</a>
              <a href="mailto:info@igwedemc.com" className="glass rounded-md px-4 py-3 text-sm flex items-center gap-2 hover:border-gold/40 transition"><Mail className="w-4 h-4 text-gold" /> info@igwedemc.com</a>
            </div>
          </div>
      ...
      <section className="pb-24">
        <div className="container-x max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((f, i) => (
              <AccordionItem key={i} value={`f-${i}`} className="glass rounded-xl border-white/10 px-6 data-[state=open]:border-gold/30 transition">
